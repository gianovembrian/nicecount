...
def get_settings() -> Settings:
    ...
    return Settings(
        ...
        default_model_path=os.getenv("DEFAULT_MODEL_PATH", "yolov8n.pt"),
        ...
        default_target_analysis_fps=max(_as_float(os.getenv("DEFAULT_TARGET_ANALYSIS_FPS"), 6.0), 0.1),
        default_preview_fps=max(_as_float(os.getenv("DEFAULT_PREVIEW_FPS"), 4.0), 0.1),
        ...
        default_inference_imgsz=max(_as_int(os.getenv("DEFAULT_INFERENCE_IMGSZ"), 960), 320),
